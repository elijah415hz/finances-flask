...
if today.day == 3:
    ...
    expensesList = [
        ...
        {'vendor': 'Xfinity', 'Amount': 60.44, 'broad_category_id': 7, 'narrow_category_id': 1, 'person_id': None, 'notes': ""},
        ...
        {'vendor': 'Wells Student Loan', 'Amount': 151.54, 'broad_category_id': 15, 'narrow_category_id': None, 'person_id': None, 'notes': ""},
        ...
        {'vendor': 'Xfinity Mobile', 'Amount': 36.42, 'broad_category_id': 5, 'narrow_category_id': 33, 'person_id': None, 'notes': ""} 
    ]
